...
interface AppleWatchModelFinderProps {
  seriesGroups: SeriesGroup[];
  categorySlug: string;
  brandSlug: string;
}

export default function AppleWatchModelFinder({
  seriesGroups,
  categorySlug,
  brandSlug,
}: AppleWatchModelFinderProps) {
  ...
  return (
    <section id="models-list" className="repair-content-band" aria-labelledby="apple-watch-model-finder-heading">
          ...
          <div className="mt-6 rounded-[24px] border border-slate-200 bg-slate-50/80 p-4 shadow-[0_18px_48px_rgba(15,23,42,0.045)] sm:p-5">
            <div className="search-container" style={{ maxWidth: "none", marginBottom: "0" }}>
              ...
              <input
                ...
                aria-label="Search Apple Watch model"
                placeholder="Search Apple Watch Series, SE, Ultra or model code"
                value={searchTerm}
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <article className="rounded-[20px] border border-blue-100 bg-white/90 p-4 shadow-sm shadow-blue-950/5">
                ...
                <p className="mt-3 text-sm font-semibold leading-6 text-slate-700">
                  Open the Watch app on your iPhone to check the exact Series or generation.
                </p>
              </article>
              <article className="rounded-[20px] border border-blue-100 bg-white/90 p-4 shadow-sm shadow-blue-950/5">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-blue-200 bg-blue-50 text-xs font-black text-blue-700">
                ...
                <p className="mt-3 text-sm font-semibold leading-6 text-slate-700">
                  Check the back of the Apple Watch to confirm the case size (e.g. 40mm, 45mm, 49mm).
                </p>
              </article>
            </div>
          </div>
