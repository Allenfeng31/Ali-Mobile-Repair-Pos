...
const CATEGORY_SEO_DATA: Record<string, any> = {
  phone: {
    ...
    faqs: [
      ...
      { question: "What if my phone has no display?", answer: "If your phone vibrates, rings or charges but the screen stays black, bring it in for a display and board-level check. We confirm whether the screen is the main fault before quoting repair." },
