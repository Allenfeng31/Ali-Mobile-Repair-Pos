...
export function buildSamsungTabletScreenReplacementPocket(
  ...
  const diagnosticSteps = [
    ...
    },
    {
      ...
      description: `Before handover, we retest ${getSamsungTabletPostRepairChecks('screen-replacement')}.`,
    },
  ] as const;
  ...
  return {
    ...
    repairOptions: [
      ...
      },
      {
        ...
        shortDescription: `After repair we retest ${getSamsungTabletPostRepairChecks('screen-replacement')} before handover.`,
