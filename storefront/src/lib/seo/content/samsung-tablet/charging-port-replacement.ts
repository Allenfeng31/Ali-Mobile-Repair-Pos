...
export function buildSamsungTabletChargingPortReplacementPocket(
  ...
  const diagnosticSteps = [
    ...
    },
    {
      ...
      description: `Before handover, we retest ${getSamsungTabletPostRepairChecks('charging-port-replacement')}.`,
    },
  ] as const;
  ...
  return {
    ...
    metaTitle: buildSamsungTabletMetaTitle(config, 'charging-port-replacement'),
    metaDescription: buildSamsungTabletMetaDescription(config, 'charging-port-replacement'),
    heroSubtitle: buildSamsungTabletHeroSubtitle(config, 'charging-port-replacement'),
    schemaDescription: buildSamsungTabletSchemaDescription(config, 'charging-port-replacement'),
    supportLabel: getSamsungTabletSupportLabel(config),
    quickAnswer: `${config.modelName} charging-port replacement helps when the charging cable only works at an angle, the connection feels loose, charging starts and stops, or accessory connection becomes unreliable. At Ali Mobile & Repair we confirm the exact Galaxy Tab model and model code, inspect the charging connector before the repair option is confirmed, and test the related functions after repair. Customers can book online or visit our Ringwood store for inspection.`,
    workbenchHeadings: {
    ...
    repairOptions: [
      ...
      },
      {
        ...
        shortDescription: `We confirm the exact ${config.modelName} model code so the charging repair information matches the correct Galaxy Tab version.`,
      ...
      },
      {
        ...
        shortDescription: `After repair we retest ${getSamsungTabletPostRepairChecks('charging-port-replacement')} before handover.`,
    ...
    diagnosticProcess: buildSamsungTabletDiagnosticProcessSection(config, 'charging-port-replacement', diagnosticSteps),
    serviceSection: buildSamsungTabletServiceSection(config, 'charging-port-replacement'),
    localService: buildSamsungTabletLocalServiceSection(config, 'charging-port-replacement'),
    finalCta: buildSamsungTabletFinalCtaSection(config, 'charging-port-replacement'),
    faq: [
      {
      ...
      {
        question: `Can I book this Samsung Tablet charging-port repair online?`,
