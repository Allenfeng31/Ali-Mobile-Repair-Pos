...
export function buildLenovoTabletBackCameraReplacementPocket(
  ...
  return {
    ...
    metaTitle: buildLenovoTabletMetaTitle(config, 'back-camera-replacement'),
    metaDescription: buildLenovoTabletMetaDescription(config, 'back-camera-replacement'),
    heroSubtitle: buildLenovoTabletHeroSubtitle(config, 'back-camera-replacement'),
    schemaDescription: buildLenovoTabletSchemaDescription(config, 'back-camera-replacement'),
    ...
    diagnosticProcess: buildLenovoTabletDiagnosticProcessSection(config, 'back-camera-replacement', diagnosticSteps),
    serviceSection: buildLenovoTabletServiceSection(config, 'back-camera-replacement'),
    localService: buildLenovoTabletLocalServiceSection(config, 'back-camera-replacement'),
    finalCta: buildLenovoTabletFinalCtaSection(config, 'back-camera-replacement'),
    faq: [
      {
      ...
      },
      {
        ...
        answer: 'We confirm the exact Lenovo tablet model and model code, test the rear-camera preview, image quality, focus, and video behaviour, and then explain the suitable repair option through the current price or quote path.',
      },
      {
      ...
      {
        question: `Can I book this Lenovo Tablet back-camera repair online?`,
