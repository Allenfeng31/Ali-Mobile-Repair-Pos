...
export function buildLenovoTabletFrontCameraReplacementPocket(
  ...
  const diagnosticSteps = [
    ...
    },
    {
      ...
      description: `Before handover, we retest ${getLenovoTabletPostRepairChecks('front-camera-replacement')}.`,
    },
  ] as const;
  ...
  return {
    ...
    metaTitle: buildLenovoTabletMetaTitle(config, 'front-camera-replacement'),
    metaDescription: buildLenovoTabletMetaDescription(config, 'front-camera-replacement'),
    heroSubtitle: buildLenovoTabletHeroSubtitle(config, 'front-camera-replacement'),
    schemaDescription: buildLenovoTabletSchemaDescription(config, 'front-camera-replacement'),
    ...
    repairOptions: [
      ...
      },
      {
        ...
        shortDescription: `We confirm the exact ${config.modelName} model code so the camera repair information matches the correct Lenovo tablet version.`,
      ...
      },
      {
        ...
        shortDescription: `After repair we retest ${getLenovoTabletPostRepairChecks('front-camera-replacement')} before handover.`,
    ...
    diagnosticProcess: buildLenovoTabletDiagnosticProcessSection(config, 'front-camera-replacement', diagnosticSteps),
    serviceSection: buildLenovoTabletServiceSection(config, 'front-camera-replacement'),
    localService: buildLenovoTabletLocalServiceSection(config, 'front-camera-replacement'),
    finalCta: buildLenovoTabletFinalCtaSection(config, 'front-camera-replacement'),
    faq: [
      {
      ...
      {
        question: `Can I book this Lenovo Tablet front-camera repair online?`,
