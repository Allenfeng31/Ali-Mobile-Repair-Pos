...
export function buildLenovoTabletFrontCameraReplacementPocket(
  ...
  const diagnosticSteps = [
    ...
    },
    {
      ...
      description: `Before pickup, we retest ${getLenovoTabletPostRepairChecks('front-camera-replacement')}.`,
    },
  ] as const;
  ...
  return {
    ...
    repairOptions: [
      ...
      },
      {
        ...
        shortDescription: `After repair we retest ${getLenovoTabletPostRepairChecks('front-camera-replacement')} before pickup.`,
