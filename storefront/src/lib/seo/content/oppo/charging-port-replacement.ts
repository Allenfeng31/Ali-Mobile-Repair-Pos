...
export function getOppoChargingPortPocket(modelSlug: string): RepairTypeSeoPocket | null {
  ...
  return {
    ...
    quickAnswer: `If your USB-C cable feels loose, charging cuts out, or the phone won't charge at all, the charging port may be damaged or obstructed. For the OPPO ${displayModel}, a replacement restores reliable wired power and data connectivity.`,
    repairOptions: [
    ...
    commonProblems: [
        ...
        { title: "Cable Not Seating Correctly", description: "The USB-C cable feels loose or falls out easily." },
    ...
    diagnosticSteps: [
        ...
        { step: "Install Replacement Port", title: "Install Replacement Port", description: "We fit a new USB-C charging flex or sub-board." },
    ...
    faq: [
        ...
        { question: "My cable feels loose, is the port broken?", answer: "Often, a loose cable is caused by compacted lint at the bottom of the USB-C port preventing a full click. We will check this during diagnosis." },
        { question: "How long does a charging port repair take?", answer: "Typically around 45 minutes to an hour once parts are available." },
        { question: "Will a new port fix slow charging?", answer: "If the current port has damaged pins limiting power delivery, a replacement will resolve it. However, slow charging can also be due to the charger itself or the battery." },
        { question: "Is the replacement part a genuine USB-C standard?", answer: "We use high-quality replacement flex cables that support the appropriate charging protocols for your device." },
