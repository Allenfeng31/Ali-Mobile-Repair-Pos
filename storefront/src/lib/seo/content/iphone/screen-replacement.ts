...
export function applyIphoneScreenReplacementSeoPocket(
  ...
  return {
    ...pocket,
    quickAnswer:
      `Need ${modelName} screen replacement in Ringwood? Ali Mobile & Repair checks cracked or damaged glass, touch-response faults, lines, flickering, available OLED or display options, frame condition, and the front sensor or Face ID area before confirming the repair path.`,
    workbenchHeadings: {
