...
export function applyIphoneBackGlassReplacementSeoPocket(
  ...
  return {
    ...
    faq: appendUniqueFaqs(pocket.faq, [
      ...
      {
        question: `Do you check the camera area before ${modelName} back glass replacement?`,
        answer:
      ...
      {
        question: `Will ${modelName} back glass replacement restore factory water resistance?`,
        answer:
