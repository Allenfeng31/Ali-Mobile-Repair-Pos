...
const faqs = [
  ...
  {
    question: "What if I am not sure what is wrong with my device?",
    answer: "That is okay. Bring the device in for a practical check and we will help identify the issue before confirming the repair."
  },
  {
    question: "Where is Ali Mobile & Repair located?",
    answer: "We are located at Kiosk C1 inside Ringwood Square Shopping Centre, Seymour St, Ringwood VIC 3134."
  }
];
