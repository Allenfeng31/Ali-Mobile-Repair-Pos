...
export const SERVICE_AREAS: ServiceArea[] = [
  {
    ...
    customLocalSection: {
      ...
      paragraphs: [
        "Ali Mobile & Repair is located at Kiosk C1 inside Ringwood Square Shopping Centre, opposite Bunnings Warehouse Ringwood and close to Eastland and Ringwood Station. We are not inside Eastland. If you are visiting Eastland, Ringwood Square or the nearby Ringwood area, you can bring your phone, tablet, Apple Watch or MacBook to our kiosk for a repair check, quote path or booking support.",
