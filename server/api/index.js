...
// ANNOUNCEMENTS
// ----------------------------------------------------------------------
const announcementHandlers = createAnnouncementHandlers({ supabase, notifyStorefrontAnnouncementChange });
app.get('/api/announcements', requireStaffAuth, announcementHandlers.get);
app.post('/api/announcements', requireStaffAuth, announcementHandlers.create);
app.put('/api/announcements/:id', requireStaffAuth, announcementHandlers.update);
app.delete('/api/announcements/:id', requireStaffAuth, announcementHandlers.remove);
