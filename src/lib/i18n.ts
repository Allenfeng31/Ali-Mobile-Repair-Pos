...
export const dict: Record<Language, Record<string, Record<string, string>>> = {
  ...
  zh: {
    ...
    term: { title: "收银台", sub: "选择要添加到当前交易的产品或维修服务。", search: "通过名称、型号或 SKU 搜索产品...", catAll: "全部商品", brandAll: "所有品牌", modelAll: "所有型号", cart: "当前购物车", empty: "购物车为空", subtotal: "小计 (不含税)", tax: "消费税 (10%)", total: "实际付款金额", confirm: "确认收银", checkout: "完成并结算订单", cancel: "取消撤回", cash: "现金支付", eftpos: "刷卡支付 (+1.5%)", surcharge: "刷卡手续费 (1.5%)", mixed: "混合支付 (Cash + Card)", outofstock: "库存不足:", limit: "达到库存上限:", success: "交易成功结算！", fail: "交易失败，请重试。", generatePDF: "直接保存下载电子发票 (PDF)", saveShare: "立刻保存 / 分享发票", printReceipt: "立刻打印实体热敏小票", generating: "正在为您生成PDF...", printTitle: "保存发票/打印小票", refundBtn: "修改此单为退款 (Refund)", refundConfirm: "您确定要将此订单全额退款吗？退款后它将从营业额底池中消失，但该记录依然会被保留留底。", refundSuccess: "订单退款状态已顺利更新！" },
